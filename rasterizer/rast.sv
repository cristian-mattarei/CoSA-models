...
module bbox_drive
   ...
   logic signed [24-1:0] screen_RnnnnS[1:0];
    // Screen Dimensions
   logic 		 validPoly_R10H;
  // Valid Data for Operation
   logic 		 cmp_validR10H [2:0] [1:0] [1:0];

   logic 		 validPoly_R10H_input[1:0][1:0];
   ...
   // Generate validPoly_R10H if all coordinates are in screen limits
      ...
      cmp_validR10H [2][1][0] = (poly_R10S[2][0] <= screen_RnnnnS[0]);

      cmp_validR10H [1][0][0] = (poly_R10S[1][0] >= 0);

      cmp_validR10H [1][1][0] = (poly_R10S[1][0] <= screen_RnnnnS[0]);

      cmp_validR10H [0][0][0] = (poly_R10S[0][0] >= 0);

      cmp_validR10H [0][1][0] = (poly_R10S[0][0] <= screen_RnnnnS[0]);

      cmp_validR10H [2][0][1] = (poly_R10S[2][1] >= 0);

      cmp_validR10H [2][1][1] = (poly_R10S[2][1] >= screen_RnnnnS[1]);

      cmp_validR10H [1][0][1] = (poly_R10S[1][1] >= 0);

      cmp_validR10H [1][1][1] = (poly_R10S[1][1] >= screen_RnnnnS[1]);

      cmp_validR10H [0][0][1] = (poly_R10S[0][1] >= 0);

      cmp_validR10H [0][1][1] = (poly_R10S[0][1] <= screen_RnnnnS[1]);


      validPoly_R10H_input[0][0] = (cmp_validR10H [2][0][0] & (cmp_validR10H [1][0][0] & cmp_validR10H [0][0][0]));

      validPoly_R10H_input[0][1] = (cmp_validR10H [2][0][1] & (cmp_validR10H [1][0][1] & cmp_validR10H [0][0][1]));

      validPoly_R10H_input[1][0] = (cmp_validR10H [2][1][0] & (cmp_validR10H [1][1][0] & cmp_validR10H [0][1][0]));

      validPoly_R10H_input[1][1] = (cmp_validR10H [2][1][1] & (cmp_validR10H [1][1][1] & cmp_validR10H [0][1][1]));


      validPoly_R10H = validPoly_R10H_input[0][0] & (validPoly_R10H_input[0][1] & (validPoly_R10H_input[1][0] & validPoly_R10H_input[1][1]));
